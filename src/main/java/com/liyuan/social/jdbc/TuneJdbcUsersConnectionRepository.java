package com.liyuan.social.jdbc;/*
...
import com.liyuan.social.jdbc.TuneJdbcConnectionRepository;
 ...
 * @author Keith Donald
 */
public class TuneJdbcUsersConnectionRepository implements UsersConnectionRepository {
	...
	public TuneJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
	...
	public ConnectionRepository createConnectionRepository(String userId) {
		...
		return new TuneJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
	}
